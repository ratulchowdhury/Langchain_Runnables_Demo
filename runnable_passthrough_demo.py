...
summary_cum_output_chain = RunnableParallel({
    "output_chain": RunnablePassthrough(),
    "summary_chain":prompt2 | llm | str_parser })
chain = topic_chain | summary_cum_output_chain
result = chain.invoke({"topic":"Russia Ukraine Conflict"})
print("Topic Response:", result["output_chain"])
print("Summary Response:", result["summary_chain"])
